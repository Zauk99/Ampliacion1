...
<body>
	...
	<form method="post">
		<label for="nombre">Nombre del Perro:</label> <input type="text" id="nombre" name="nombre" required> 
		<br>
		<br> 
		<label for="raza">Raza del Perro:</label> <input type="text" id="raza" name="raza" required> 
		<br>
		<br> 
		<label for="fechaNacimiento">Fecha de Nacimiento:</label> <input type="date" id="fechaNacimiento" name="fechaNacimiento" required>
		<br>
		<br> 
